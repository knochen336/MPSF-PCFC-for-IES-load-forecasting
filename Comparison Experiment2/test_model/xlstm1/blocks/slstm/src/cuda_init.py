...
import os
os.environ["PATH"] = os.environ["PATH"] + ":/ninja/in/conda/bin"

# os.environ["PATH"] = os.environ["PATH"] + ":/C:/Users/admin/.conda/envs/lxy_ts/lib/site-packages/ninja/to/ninja/in/conda/bin"
