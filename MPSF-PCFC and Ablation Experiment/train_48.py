...
parser.add_argument('--save', type=str, default='model/model_lnn48.pt',
...
def main():
    ...
    with open('./result/data48.txt', 'a') as f:  # 设置文件对象
    ...
    best_val = 10000000
    optim = Optim(
        model.parameters(), args.optim, args.lr, args.clip, 'min', 0.5, 5, lr_decay=args.weight_decay
    )
    ...
    # 保存为 .pt 文件
    torch.save(all_y_true, './result/all_y_true48.pt')
    torch.save(all_predict_value, './result/all_predict_value48.pt')
    ...
    # 保存为 .npy 文件
    np.save('./result/all_y_true48.npy', all_y_true_np)
    np.save('./result/all_predict_value48.npy', all_predict_value_np)
