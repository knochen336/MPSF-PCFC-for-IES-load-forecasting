...
parser.add_argument('--save', type=str, default='model/model_lnn48_changecfc.pt',
...
parser.add_argument('--epochs', type=int, default=28, help='')
...
def main():
    ...
    with open('./result/data48_changecfc.txt', 'a') as f:  # 设置文件对象
    ...
    # 保存为 .pt 文件
    torch.save(all_y_true, './result/all_y_true48_changecfc.pt')
    torch.save(all_predict_value, './result/all_predict_value48_changecfc.pt')
    ...
    # 保存为 .npy 文件
    np.save('./result/all_y_true48_changecfc.npy', all_y_true_np)
    np.save('./result/all_predict_value48_changecfc.npy', all_predict_value_np)
