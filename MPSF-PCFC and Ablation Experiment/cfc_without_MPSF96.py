...
parser.add_argument('--save', type=str, default='model/model_lnn96_withoutSparse.pt',
...
def main():
    ...
    with open('./result/data96_withoutSparse.txt.txt', 'a') as f:  # 设置文件对象
    ...
    try:
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            with open('./result/data96_withoutSparse.txt', 'a') as f:  # 设置文件对象
                print(
    ...
    # 保存为 .pt 文件
    torch.save(all_y_true, './result/all_y_true96_withoutSparse.pt')
    torch.save(all_predict_value, './result/all_predict_value96_withoutSparse.pt')
    ...
    # 保存为 .npy 文件
    np.save('./result/all_y_true96_withoutSparse.npy', all_y_true_np)
    np.save('./result/all_predict_value96_withoutSparse.npy', all_predict_value_np)
