...
def main():
    ...
    with open('./result/data96.txt', 'a') as f:  # 设置文件对象
    ...
    # 保存为 .pt 文件
    torch.save(all_y_true, './result/all_y_true96.pt')
    torch.save(all_predict_value, './result/all_predict_value96.pt')
    ...
    # 保存为 .npy 文件
    np.save('./result/all_y_true96.npy', all_y_true_np)
    np.save('./result/all_predict_value96.npy', all_predict_value_np)
