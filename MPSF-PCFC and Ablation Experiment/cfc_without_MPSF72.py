...
parser.add_argument('--save', type=str, default='model/model_lnn72_withoutSparse.pt',
...
def main():
    ...
    with open('./result/data72_withoutSparse.txt', 'a') as f:  # 设置文件对象
    ...
    # 保存为 .pt 文件
    torch.save(all_y_true, './result/all_y_true72_withoutSparse.pt')
    torch.save(all_predict_value, './result/all_predict_value72_withoutSparse.pt')
    ...
    # 保存为 .npy 文件
    np.save('./result/all_y_true72_withoutSparse.npy', all_y_true_np)
    np.save('./result/all_predict_value72_withoutSparse.npy', all_predict_value_np)
